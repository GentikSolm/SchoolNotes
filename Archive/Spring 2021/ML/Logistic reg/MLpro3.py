...
scatter = ax.scatter(X_train['trestbps'], X_train['age'], X_train['chol'], c = y_train, s=100)
...
X_train, X_test, y_train, y_test = train_test_split(X, y, random_state=5, test_size = .25, train_size = .75)
